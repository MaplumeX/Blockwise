...
- [ ] 时间线页具备 Week Range Title + Week Strip + Calendar Jump + Today 快捷入口
- [ ] 周切换保持“选中星期”语义
- [ ] 日期切换数据一致（无闪动/无错误日期数据）
